 ...
 * @author Vishal
 */
public class sbbl extends javax.swing.JFrame {
  ...
  public sbbl() {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Search tickets for Bus");
        ...
        tb1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Bus no.", "Departure Time", "AC Seats Available", "Sleeper Seats Available", "General Seats Available"
            }
        ) {
        ...
        if (tb1.getColumnModel().getColumnCount() > 0) {
            ...
            tb1.getColumnModel().getColumn(0).setMaxWidth(100);
            tb1.getColumnModel().getColumn(1).setPreferredWidth(100);
            tb1.getColumnModel().getColumn(1).setMaxWidth(100);
